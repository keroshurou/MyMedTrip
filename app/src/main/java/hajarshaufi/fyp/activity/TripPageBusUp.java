...
public class TripPageBusUp extends AppCompatActivity {
    ...
    String url = "http://10.200.66.178/mymedtrip/fetchBusUp.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trip_page_bus_up);
    ...
    private void getBusBookingData() {
        ...
        RequestQueue queue = Volley.newRequestQueue(TripPageBusUp.this);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url,
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(TripPageBusUp.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
