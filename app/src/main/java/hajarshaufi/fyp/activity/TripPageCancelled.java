...
public class TripPageCancelled extends AppCompatActivity {
    ...
    public static ArrayList<Trip> tripCancelledList = new ArrayList<>();
    Trip trip;
    ...
    private void getDataCancelled() {

        RequestQueue queue = Volley.newRequestQueue(TripPageCancelled.this);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url,
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(TripPageCancelled.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
