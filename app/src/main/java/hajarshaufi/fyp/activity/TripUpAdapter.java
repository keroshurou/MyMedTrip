...
public class TripUpAdapter extends ArrayAdapter<Trip> {
    ...
    private String id;
    String url = "http://10.200.66.178/mymedtrip/updateTrip.php";
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        btnChangeStatus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                id = arrayTripList.get(position).getId();
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if ("Upcoming".equals(selectedOption)) {
                                    updateUpcoming();
                                    Intent intent = new Intent(itemView.getContext(), TripPageUpcoming.class);
                                    itemView.getContext().startActivity(intent);
                                } else if ("Completed".equals(selectedOption)) {
                                    updateCompleted();
                                    Intent intent = new Intent(itemView.getContext(), TripPageCompleted.class);
                                    itemView.getContext().startActivity(intent);
                                } else if ("Cancelled".equals(selectedOption)) {
                                    updateCancelled();
                                    Intent intent = new Intent(itemView.getContext(), TripPageCancelled.class);
                                    itemView.getContext().startActivity(intent);
                                }
